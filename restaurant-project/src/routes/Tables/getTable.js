...
export default function GetTable({table}) {
    ...
    return (
        <Card
            ...
            extra={<Button className='button-style-card' onClick={onEditBtnClick}> <EditOutlined/>Edit</Button>}
            style={{width: 330}}>
            <Button className='button-style-card-danger'  danger onClick={onDeleteClick}> <DeleteOutlined/>Delete</Button>
        </Card>
    )
}